namespace TransactionDataUploader.Core.Utilities.Helpers
{
    public static class StaticDataProvider
    {
        public static string[] GetAllIso4217CurrencyCodes()
        {
            return new[]
            {
                ...
                "XBD", "XCD", "XDR", "XFU", "XOF", "XPD", "XPF", "XPT", "XTS", "XXX", "YER", "ZAR", "ZMW"
            };
        }

        public static string[] GetCsvDataTransactionsStatues()
        {
            return new string[]
            {
                "Approved",
        ...
        public static string[] GetXMLDataTransactionsStatues()
        {
            return new string[]
            {
                "Approved",
